public class SpecialEventTicket extends Ticket{
     ...
     * It is the Ticket instance of SPECIAL EVENT
     *
     ...
     * */
    SpecialEventTicket(int ticketId, int entryTime, int exitTime){
        ...
        this.type = "SPECIAL";
        typeOfCalc = new SpecialEventCalculation();
    }

    //Constructor takes the parameters that will be needed by the
